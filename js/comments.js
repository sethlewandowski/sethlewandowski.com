(function() {
	...
	function showForm(uri) {
		...
		if () {
			...
			<textarea name="comment" id="comment" cols="80" rows="10"></textarea><br>
			<input name="submit" type="submit" class="submit" value="submit comment" /></form></header>
			<h1>Comments</h1><div id="commentlist"></div>';
		}
	}
